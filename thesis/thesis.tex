...
\feedback{might be me, but I still don’t see clearly how this differs:
flaky test: test failes in-deterministically
flaky failure: test with test failures?}
...
\TODO{Review the definitions of TP, FP, TN, FN}
...
\TODO{Further explain the changes we made to the tests and why they were necessary.}
...
\feedback{can we have the full table with this adjustment in the appendix?}
...
Lastly, we calculated the \emph{precision}, \emph{recall}, and \emph{f1 score} for the approach in general by combining the results from both study subjects weighted by number of failures that were analyzed.
...
\TODO{Mention the worst case runtime increase}
...
\begin{mdframed}
	...
	While other studies indicate that instrumentation does not have a significant impact on the failure rate of \ac{e2e} tests \autocite{rasheed_effect_2023}, we can not come to a definitive conclusion.
\end{mdframed}
%------- chapter 6 -------
...
\TODO{General concluding remarks}
