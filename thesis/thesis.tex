...
\Citeauthor*{haben_importance_2023} conducted a study subject on the Chromium \ac{ci}, using state-of-the-art flakiness prediction methods to examine their performance.
...
Different from \citeauthor*{bell_deflaker_2018}, we face new challenges as we have to collect coverage across multiple processes and multiple languages.
...
They analyze each change and decide how to track coverage for that particular change \autocite{bell_deflaker_2018}.
...
\TODO{DeFlaker vergleich auch in conclusion}
